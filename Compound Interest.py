...
fluctuation = float(input("Entrez la fluctuation annuelle en % (sous forme décimale) : "))
...
def compoundInterest(capital, reInvestment, apy, fluctuation, paymentDuration, years):
    totalDays = years * 365
    monthlyFluctuation = fluctuation / 12
...
compoundInterest(capital, reInvestment, apy, fluctuation, paymentDuration, years)